                                    ...
                                    <td class="min-w-80">
                                        ...
                                        <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                                            @foreach ($stateOptions as $stateCode => $stateName)
                                                <label class="inline-flex items-center gap-2 text-xs text-app-copy cursor-pointer" title="{{ $stateName }}">
                                                    <input
                                                        type="checkbox"
                                                        ...
                                                        class="h-4 w-4 rounded border-app-border text-brand-navy focus:ring-brand-navy disabled:opacity-50 js-state-checkbox cursor-pointer"
                                                    >
                                                    <span>{{ $stateCode }}</span>
                                                </label>
                                            @endforeach
